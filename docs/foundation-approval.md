...
| "My Approvals" inbox page | n/a | [`ApprovalInboxView.tsx`](../src/frontend/src/workspace/views/client/ApprovalInboxView.tsx) — filter chips, SLA bars, decide/reject/return inline, notification-driven refresh; [`ApprovalService.ts`](../src/frontend/src/services/ApprovalService.ts) HTTP client | [Phase 1 B2, C2](../roadmap/foundation/approval/phase-1-implementation.md#b2-inbox-page--approvalinboxview-react-component) |
...
|---|---|---|
| `approval.inbox` client-action absent in `src/frontend` — legacy `ApprovalInboxView` won't be ported; ships fresh per the [frozen mockup](../roadmap/foundation/approval/mockups/approval-inbox-frozen.html) (Triage × Dashboard hybrid, sticky focus card, workflow chain, ocean-blue accent). Approvers cannot triage in frontend2 until this lands. | 🔴 | [Approval Enhancement 02](../roadmap/foundation/approval/enhancements/02-approval-inbox-frontend2.md) |
