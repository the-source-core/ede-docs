...
| [Document Report Engine (DRE)](foundation-document.md) | `foundation.document` (all 3 phases 🔴 — DML v1.1 parser + PDF/HTML/print renderer + template inheritance) | [roadmap/foundation/document/](../roadmap/foundation/document/README.md) |
