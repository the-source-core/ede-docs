...
| Doc | Module | Roadmap |
|---|---|---|
| [AI Capability Layer](foundation-ai.md) | `foundation.ai` (all 4 phases 🔴 — provider abstraction + `@api.ai_tool` decorator + tool/prompt registries + `ai.conversation` primitives + read-only function-calling bridge + cost/audit; HARD prereq for `foundation.assistant` + `foundation.mcp`; safety hardening + embeddings + gated write-mode in later phases) | [roadmap/foundation/ai/](../roadmap/foundation/ai/README.md) |
| [AI Assistant (Chat Companion to Actions)](foundation-assistant.md) | `foundation.assistant` (all 4 phases 🔴 — in-app chat sidebar bound to active `ActionContext`; AI-emitted view-intent ops auto-apply to filter/sort/groupby chips with ✨ marker; click-to-confirm `actions[]` for navigate/open-record/export; configurations & properties assistant in Phase 3; gated write-mode + domain skill packs in Phase 4) | [roadmap/foundation/assistant/](../roadmap/foundation/assistant/README.md) |
...
| [Background Jobs Engine](foundation-jobs.md) | `foundation.jobs` (all 3 phases 🔴 — HARD prereq for `onemaster` Phase 1) | [roadmap/foundation/jobs/](../roadmap/foundation/jobs/README.md) |
| [Base (Platform Substrate)](foundation-base.md) | `foundation.base` (✅ Delivered baseline — `res.*` cross-domain masters + `ir.*` platform metadata + health-check; root of the foundation dependency graph) | [roadmap/foundation/base/](../roadmap/foundation/base/README.md) |
...
| [Country Localization SDK (l10n)](foundation-l10n.md) | `foundation.l10n` (all 3 phases 🔴 — country-scope extension SDK via `@api.extend_model("model.key", country="CC")`; per-org pack activation; Phase 2 ships `localizations.in` HSN/GST/PAN/GSTIN; Phase 3 adds US/EU/AE packs + reporting/document integration) | [roadmap/foundation/l10n/](../roadmap/foundation/l10n/README.md) |
...
| [Document Engine (Intellex DML)](foundation-document.md) | `foundation.document` (all 3 phases 🔴 — DML v1.1 parser + PDF/HTML/print renderer + template inheritance) | [roadmap/foundation/document/](../roadmap/foundation/document/README.md) |
...
| [Workflow Engine](foundation-workflow.md) | `foundation.workflow` (Phase 1 ✅, Phase 2 🟡) | [roadmap/foundation/workflow/](../roadmap/foundation/workflow/README.md) |
...
| [OneMaster — Global Logistics Master Data Hub](../src/domains/onemaster/docs/onemaster.md) | `onemaster.*` (standalone hub server — all 5 phases 🔴 Not Started) | [roadmap/onemaster/](../roadmap/onemaster/README.md) |
